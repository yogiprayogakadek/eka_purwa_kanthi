        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control perihal_rapat" name="perihal_rapat" id="perihal-rapat" placeholder="masukkan perihal rapat">
                    <div class="invalid-feedback error-perihal_rapat"></div>
                </div>
                <div class="form-group">
                    <label for="tanggal-rapat">Tanggal Rapat</label>
                    <input type="date" class="form-control tanggal_rapat" name="tanggal_rapat" id="tanggal-rapat" placeholder="masukkan tanggal rapat">
                    <div class="invalid-feedback error-tanggal_rapat"></div>
                </div>
                <div class="form-group">
                    <label for="tempat-rapat">Tempat rapat</label>
                    <input type="text" class="form-control tempat_rapat" name="tempat_rapat" id="tempat-rapat" placeholder="masukkan tempat rapat">
                    <div class="invalid-feedback error-tempat_rapat"></div>
                </div>
                <div class="form-group">
                    <label for="pimpinan-rapat">Pimpinan Rapat</label>
                    <input type="text" class="form-control pimpinan_rapat" name="pimpinan_rapat" id="pimpinan-rapat" placeholder="masukkan pimpinan rapat">
