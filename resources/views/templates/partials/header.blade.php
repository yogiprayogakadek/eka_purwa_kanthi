<div class="app-header header sticky" style="margin-bottom: -74px;">
    <div class="container-fluid main-container">
        <div class="d-flex"> <a {{Request::is('voting') ? 'hidden'  : '' }} aria-label="Hide Sidebar" class="app-sidebar__toggle"
                ...
                class="logo-horizontal " href="index.html"> <img src="{{asset('assets/images/logo-stt.jpeg')}}"
                    class="header-brand-img desktop-logo" alt="logo" height="80px"> <img
                    src="{{asset('assets/images/logo-stt.jpeg')}}" height="80px" class="header-brand-img light-logo1"
                    alt="logo"> </a> <!-- LOGO -->
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            ...
                                            </h5> <small class="text-muted">{{auth()->user()->jabatan->nama_jabatan}}</small>
                                        </div>
                                    </div>
